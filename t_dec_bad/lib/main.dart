...
class _MainAppState extends State<MainApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        body: mediaQuerySize.width < 1024 || mediaQuerySize.height < 768
            ? Center(
                child: Text(
                  'Esta aplicacion esta disenada para ser usada en una ventana de por lo menos 1024x768 pixeles.\nSu resolucion actual es: ${mediaQuerySize.width}x${mediaQuerySize.height}',
