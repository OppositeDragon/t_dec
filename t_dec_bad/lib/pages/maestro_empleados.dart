                    ...
                    child: SizedBox(
                      ...
                      child: DataTable(
                        ...
                        columns: [
                          ...
                          const DataColumn(label: Text('Acciones'), tooltip: 'Acciones')
                        ],
                        rows: [
                          for (int i = 0; i < empleados.length; i++)
                            DataRow(
                              ...
                              cells: [
                                ...
                                if (constraints.maxWidth > 700) DataCell(Text(empleados[i].correo)),
                                if (constraints.maxWidth > 700) DataCell(Text(empleados[i].direccion)),
                                DataCell(
                                  empleados[i].estado
                      ...
                      Expanded(
                        child: TabBarView(
                          children: [
                                    ...
                                    children: [
                                      const Card(
                                        child: Padding(
                                          ...
                                          child: Row(children: [
                                            Spacer(),
                                            Text('Forma de pago para el mes actual:  '),
                                            Flexible(
                                              child: TextField(
                                                decoration: InputDecoration(
                                                  hintText: 'Forma pago',
                            ...
                            SingleChildScrollView(//impuesto a la renta
                              child: Column(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  const SizedBox(height: 8),
                                            ...
                                            Stack(
                                              ...
                                              children: [
                                                const Card(
                                                  child: Padding(
                                                    padding:
                                                        EdgeInsets.only(bottom: 12.0, top: 28, left: 12, right: 12),
                                                    child: TextField(
                                                      decoration: InputDecoration(
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                const Row(
                                  children: [
                                    SizedBox(width: 16),
                                    Text('Dias adicionales de vacaciones: '),
                                    Flexible(
                                      child: TextField(
                                        decoration: InputDecoration(
                                          isDense: true,
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  Flexible(flex: 1,fit:FlexFit.tight, child: Text('Lista de valores')),
                                                  SizedBox(width: 16.0),
                                                  Flexible(
                                                    flex: 3,
                                                    child: TextField(
                                              ...
                                              Row(
                                                children: [
                                                  Flexible(flex: 1, fit:FlexFit.tight, child: Text('Area general')),
                                                  SizedBox(width: 16.0),
                                                  Flexible(
                                                    flex: 3,
                                                    child: TextField(
                                              ...
                                              Row(
                                                children: [
                                                  Flexible(flex: 1, fit:FlexFit.tight, child: Text('Fecha especial')),
                                                  SizedBox(width: 16.0),
                                                  Flexible(
                                                    flex: 3,
                                                    child: TextField(
                                              ...
                                              Row(
                                                children: [
                                                  Flexible(flex: 1, fit:FlexFit.tight, child: Text('Valor 2')),
                                                  SizedBox(width: 16.0),
                                                  Flexible(
                                                    flex: 3,
                                                    child: TextField(
                                              ...
                                              Row(
                                                children: [
                                                  Flexible(flex: 1, fit:FlexFit.tight, child: Text('Personalizado 5')),
                                                  SizedBox(width: 16.0),
                                                  Flexible(
                                                    flex: 3,
                                                    child: TextField(
                                              ...
                                              Row(
                                                children: [
                                                  Flexible(flex: 1,fit:FlexFit.tight,  child: Text('Personalizado 6')),
                                                  SizedBox(width: 16.0),
                                                  Flexible(
                                                    flex: 3,
                                                    child: TextField(
